...
export interface PluginRegistryReadOnlyInterface {
  ...
  getPluginByAddress: ({
    ...
    contractAddr: string;
  }) => Promise<PluginWithVersionResponse>;
...
export class PluginRegistryClient extends PluginRegistryQueryClient implements PluginRegistryInterface {
  ...
  constructor(client: SigningCosmWasmClient, sender: string, contractAddress: string) {
    ...
    this.proxyRemovePlugins = this.proxyRemovePlugins.bind(this);
    ...
    this.addOrUpdateSubscriptionTiers = this.addOrUpdateSubscriptionTiers.bind(this);
  }
  ...
  addOrUpdateSubscriptionTiers = async ({
    details,
    tier
  }: {
    details: TierDetails;
