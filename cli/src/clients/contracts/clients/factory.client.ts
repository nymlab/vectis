...
export class FactoryQueryClient implements FactoryReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.walletCreator = this.walletCreator.bind(this);
  ...
  walletCreator = async (): Promise<Addr> => {
    return this.client.queryContractSmart(this.contractAddress, {
      wallet_creator: {}
    });
  };
...
export class FactoryClient extends FactoryQueryClient implements FactoryInterface {
  ...
  constructor(client: SigningCosmWasmClient, sender: string, contractAddress: string) {
    ...
    this.updateWalletCreator = this.updateWalletCreator.bind(this);
