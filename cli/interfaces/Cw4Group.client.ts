...
export interface Cw4GroupReadOnlyInterface {
    ...
    totalWeight: ({ atHeight }: { atHeight?: number }) => Promise<TotalWeightResponse>;
    listMembers: ({ limit, startAfter }: { limit?: number; startAfter?: string }) => Promise<MemberListResponse>;
...
export class Cw4GroupQueryClient implements Cw4GroupReadOnlyInterface {
    ...
    totalWeight = async ({ atHeight }: { atHeight?: number }): Promise<TotalWeightResponse> => {
        return this.client.queryContractSmart(this.contractAddress, {
            total_weight: {
                at_height: atHeight,
            },
    ...
    member = async ({ addr, atHeight }: { addr: string; atHeight?: number }): Promise<MemberResponse> => {
        return this.client.queryContractSmart(this.contractAddress, {
            member: {
                addr,
                at_height: atHeight,
