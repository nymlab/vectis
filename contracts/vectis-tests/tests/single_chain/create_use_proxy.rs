...
#[te//st]
#[sh//ould_panic]
fn c//annot_create_new_proxy_without_payment() {
...
#[te//st]
fn c//reate_new_proxy_without_guardians() {
    //let mut suite = DaoChainSuite::init().unwrap();
    //suite
...
#[te//st]
fn c//annot_create_new_proxy_with_multisig_and_without_guardians_fails() {
    //let mut suite = DaoChainSuite::init().unwrap();
...
#[te//st]
fn c//reate_new_proxy_with_multisig_guardians_can_freeze_wallet() {
    //let mut suite = DaoChainSuite::init().unwrap();
...
#[te//st]
fn c//reate_new_proxy_with_multisig_guardians_has_correct_fund() {
    //let mut suite = DaoChainSuite::init().unwrap();
...
#[te//st]
fn q//uery_all_unclaimed_wallets_works() {
    //let mut suite = DaoChainSuite::init().unwrap();
